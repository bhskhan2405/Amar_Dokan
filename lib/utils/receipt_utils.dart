...
class ReceiptUtils {
  ...
  static Future<void> generatePosReceipt({
    ...
    // Ensure language is synced for History view
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
                      ...
                      children: [
                        pw.Row(
                          ...
                          children: [
                            ...
                            // Discount % and Taka (Unified Style)
                            ...
                            pw.Expanded(flex: 2, child: _bt((itemTotalBeforeDiscount - discountAmountTk).toStringAsFixed(2), font: shapedBold, fontSize: 8, align: ShapedTextAlign.end)),
                          ],
                        ),
              ...
              // 7. Totals Section (Professional Alignment)
